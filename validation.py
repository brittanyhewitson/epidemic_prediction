...
def model_predict(model_name, model, X_train, y_train, X_test, y_test, X_val, y_val, **kwargs):
    """
    """
    ...
    history = model.fit(X_train, y_train, validation_data=(X_val, y_val), **kwargs)
...
def main():
    ...
    classifier_results, classifier_history = model_predict( #, history
                'simple_classifier',
                simple_classifier,
                X_train,
                y_train,
	...
	#plot loss
    loss_train = classifier_history.history['loss']
    loss_val = classifier_history.history['val_loss']
    ...
    acc_train = classifier_history.history['accuracy']
    acc_val = classifier_history.history['val_accuracy']
    ...
    # plt.scatter(y_test, classifier_results["outputs"])
